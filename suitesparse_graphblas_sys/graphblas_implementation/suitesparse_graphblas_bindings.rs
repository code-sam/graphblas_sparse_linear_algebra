...
pub const GxB_IMPLEMENTATION_NAME: &[u8; 22usize] = b"SuiteSparse:GraphBLAS\0";
pub const GxB_IMPLEMENTATION_DATE: &[u8; 13usize] = b"Oct 14, 2022\0";
pub const GxB_IMPLEMENTATION_MAJOR: u32 = 7;
pub const GxB_IMPLEMENTATION_MINOR: u32 = 3;
pub const GxB_IMPLEMENTATION_SUB: u32 = 0;
pub const GxB_SPEC_DATE: &[u8; 13usize] = b"Nov 15, 2021\0";
pub const GxB_SPEC_MAJOR: u32 = 2;
pub const GxB_SPEC_MINOR: u32 = 0;
pub const GxB_SPEC_SUB: u32 = 0;
pub const GRB_VERSION: u32 = 2;
pub const GRB_SUBVERSION: u32 = 0;
...
pub const GxB_COMPRESSION_INTEL: u32 = 1000000;
...
pub const GrB_Info_GxB_EXHAUSTED: GrB_Info = 2;
...
pub const GrB_Mode_GxB_NONBLOCKING_GPU: GrB_Mode = 2;
pub const GrB_Mode_GxB_BLOCKING_GPU: GrB_Mode = 3;
...
pub const GrB_Desc_Field_GxB_COMPRESSION: GrB_Desc_Field = 36;
pub const GrB_Desc_Field_GxB_IMPORT: GrB_Desc_Field = 37;
...
pub const GrB_Desc_Value_GxB_SECURE_IMPORT: GrB_Desc_Value = 502;
...
extern "C" {
    pub fn GxB_Scalar_memoryUsage(size: *mut size_t, s: GrB_Scalar) -> GrB_Info;
}
extern "C" {
...
extern "C" {
    pub fn GxB_Vector_memoryUsage(size: *mut size_t, v: GrB_Vector) -> GrB_Info;
}
extern "C" {
...
extern "C" {
    pub fn GxB_Matrix_memoryUsage(size: *mut size_t, A: GrB_Matrix) -> GrB_Info;
}
extern "C" {
...
pub const GxB_Option_Field_GxB_COMPILER_VERSION: GxB_Option_Field = 23;
pub const GxB_Option_Field_GxB_COMPILER_NAME: GxB_Option_Field = 24;
...
pub const GxB_Option_Field_GxB_PRINTF: GxB_Option_Field = 101;
pub const GxB_Option_Field_GxB_FLUSH: GxB_Option_Field = 102;
pub const GxB_Option_Field_GxB_MEMORY_POOL: GxB_Option_Field = 103;
pub const GxB_Option_Field_GxB_PRINT_1BASED: GxB_Option_Field = 104;
...
extern "C" {
    pub fn GxB_SelectOp_wait(op: GxB_SelectOp, waitmode: GrB_WaitMode) -> GrB_Info;
}
extern "C" {
...
fn bindgen_test_layout_GB_Iterator_opaque() {
    ...
    fn test_field_pstart() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
    ...
    fn test_field_pmax() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).pmax) as usize - ptr as usize
            },
            40usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_avlen() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).avlen) as usize - ptr as usize
            },
            48usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_avdim() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).avdim) as usize - ptr as usize
            },
            56usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_anvec() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).anvec) as usize - ptr as usize
            },
            64usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_Ah() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).Ah) as usize - ptr as usize
            },
            80usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_Ab() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).Ab) as usize - ptr as usize
            },
            88usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_Ai() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).Ai) as usize - ptr as usize
            },
            96usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_Ax() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).Ax) as usize - ptr as usize
            },
            104usize,
            concat!(
                "Offset of field: ",
    ...
    fn test_field_type_size() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).type_size) as usize - ptr as usize
            },
            112usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_type_size();
    fn test_field_A_sparsity() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).A_sparsity) as usize - ptr as usize
            },
            120usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_A_sparsity();
    fn test_field_iso() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).iso) as usize - ptr as usize
            },
            124usize,
            concat!(
                "Offset of field: ",
    ...
    test_field_iso();
    fn test_field_by_col() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<GB_Iterator_opaque>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).by_col) as usize - ptr as usize
            },
            125usize,
            concat!(
                "Offset of field: ",
...
pub const RMM_MODE_rmm_wrap_host: RMM_MODE = 0;
pub const RMM_MODE_rmm_wrap_host_pinned: RMM_MODE = 1;
pub const RMM_MODE_rmm_wrap_device: RMM_MODE = 2;
pub const RMM_MODE_rmm_wrap_managed: RMM_MODE = 3;
pub type RMM_MODE = ::std::os::raw::c_uint;
extern "C" {
    pub fn rmm_wrap_finalize();
}
extern "C" {
    pub fn rmm_wrap_initialize(
        mode: RMM_MODE,
        init_pool_size: size_t,
        max_pool_size: size_t,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn rmm_wrap_allocate(size: *mut size_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn rmm_wrap_deallocate(p: *mut ::std::os::raw::c_void, size: size_t);
}
extern "C" {
    pub fn rmm_wrap_malloc(size: size_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn rmm_wrap_calloc(n: size_t, size: size_t) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn rmm_wrap_realloc(
        p: *mut ::std::os::raw::c_void,
        newsize: size_t,
    ) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn rmm_wrap_free(p: *mut ::std::os::raw::c_void);
}
