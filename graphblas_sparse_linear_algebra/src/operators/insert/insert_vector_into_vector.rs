...
pub trait InsertVectorIntoVectorTrait<VectorToInsertInto>
where
...
impl<VectorToInsertInto: ValueType> InsertVectorIntoVectorTrait<VectorToInsertInto>
...
mod tests {
    ...
    fn test_insert_vector_into_vector() {
        ...
        assert_eq!(vector.get_element_value_or_default(&2).unwrap(), 3);
        assert_eq!(vector.get_element_value_or_default(&4).unwrap(), 11);
        assert_eq!(vector.get_element_value_or_default(&5).unwrap(), 12);
