...
implement_trait_for_4_type_data_type_and_all_value_types!(Send, MatrixMultiplicationOperator);
implement_trait_for_4_type_data_type_and_all_value_types!(Sync, MatrixMultiplicationOperator);
